 ...
 * @date 2024/02/21
 */
public class JDBCUtils备份 {
    private static String USERNAME;
    private static String PWD;
    private static String URL;
    private static String DRIVER;
    private static Properties properties;
    private static JDBCUtils备份 jdbcUtils = null;


    public static void main(String[] args) {
        try {
            JDBCUtils备份.getConnection();
    ...
    static {
        ...
        try {
            ...
            properties.load(JDBCUtils备份.class.getClassLoader().getResourceAsStream("database.properties"));
     ...
     * 获得实例
     *
     * @return {@link JDBCUtils备份}
     */
    public static JDBCUtils备份 getInstance() {
        if (jdbcUtils != null) {
            return new JDBCUtils备份();
        } else {
            return jdbcUtils;
        }
    }
