...
public class JDBCUtils2 {
    ...
    private static JDBCUtils2 jdbcUtils = null;
    ...
    static {
        ...
        try {
            ...
            properties.load(JDBCUtils2.class.getClassLoader().getResourceAsStream("database.properties"));
     ...
     * 获得实例
     *
     * @return {@link JDBCUtils2}
     */
    public static JDBCUtils2 getInstance() {
        if (jdbcUtils != null) {
